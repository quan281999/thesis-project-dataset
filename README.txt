This dataset is from https://archive.ics.uci.edu/ml/datasets/2.4+GHZ+Indoor+Channel+Measurements
References:
1- First paper
...
The dataset is converted from .csv files into .s2p files for analyzing purposes.
